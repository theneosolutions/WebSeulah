...
const MainLoan = () => {
  ...
  const getBackgroundSize = () => {
    return {
      backgroundSize: `SAR{(sliderValue * 100) / MAX}% 100%`,
    };
  };
  return (
            ...
            <div className="col-lg-12">
              <div className="main-content">
                <div className="section-text">
                  <h4 className="title">
Verify your eligibile limit for loan </h4>
                  <p>
                    this is the main loan Formamount that you need (SAR 1,000 to
                    SAR 50,000) and the payment period (6–18 months) that suits you
                    best.
                  </p>
                </div>
                <form action="#">
                  <div className="form-group">
                    <div className="range-amount">
                      <h4 className="d-flex flex-column align-items-center justify-content-center">
                        <label>
                         Loan Amount : <span> SAR {sliderValue}</span>
                        </label>
                        <input
                          type={"range"}
                          min={1000}
                  ...
                  <div className="bottom-area pt-120 d-xl-flex align-items-center justify-content-between">
                    <div className="tab-content">
                      ...
                      >
                        <h5>
                          Monthly Payment: <span>SAR 608.89</span>
                        </h5>
                      </div>
                      <div
                      ...
                      >
                        <h5>
                          Monthly Payment: <span>SAR 1208.89</span>
                        </h5>
                      </div>
                      <div
                        className="tab-pane fade"
                      ...
                      >
                        <h5>
                          Monthly Payment: <span>SAR 1808.89</span>
                        </h5>
                      </div>
                      <div
                        className="tab-pane fade"
                      ...
                      >
                        <h5>
                          Monthly Payment: <span>SAR 2408.89</span>
                        </h5>
                      </div>
                    </div>
